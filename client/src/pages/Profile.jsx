...
import { FaArrowRight, FaPlay, FaUser } from "react-icons/fa";
import { updateProfile } from "../services/authService";
import { updateUserName } from "../store/Slice/auth-slice";
      ...
      <section className="authShell" aria-label="Hồ sơ cá nhân">
        <div className="authBrand">
          ...
          <div className="authBrand__copy">
            ...
            <p>Cập nhật thông tin hồ sơ để tài khoản của bạn thêm cá nhân.</p>
          </div>
        </div>
        ...
        <div className="authPanel">
          ...
          {success && (
            <div className="authNotice authNotice--success">Đã cập nhật tên thành công!</div>
          )}
          ...
          <form className="authForm" onSubmit={handleSubmit}>
            ...
            <button className="authSubmit" type="submit" disabled={isLoading || name.trim() === user.name}>
